  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '20px 18px 14px', borderBottom: '1px solid var(--border)', flexShrink: 0 }}>
        ...
        <div style={{ fontSize: 9, color: 'var(--muted)', marginTop: 3, fontFamily: 'var(--font-mono)' }}>v4.0 · Railway</div>
      </div>
            ...
            {group.items.map(item => (
              ...
              >
                ...
                {item.countKey && counts[item.countKey] > 0 && (
                  <span style={{
                    marginLeft: 'auto', background: 'rgba(0,229,160,0.13)',
                    color: 'var(--accent)', fontSize: 9.5, padding: '1px 6px',
